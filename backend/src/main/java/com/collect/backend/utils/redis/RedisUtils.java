...
public class RedisUtils {
    ...
    public static Long inc(String key, Long time, TimeUnit unit) {
    ...
    /**
     * HashSet,如果步存在则创建，存在则啥都不干
     *
     * @param key 键
     * @param map 对应多个键值
     * @return true 成功 false 失败
     */
    public static Boolean hmsetIfAbsent(String key, Map<Object, Object> map) {
        try {
    ...
    public static Boolean zAddToStr(String key, Object value, double score) {
